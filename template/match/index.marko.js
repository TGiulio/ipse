...
var marko_template = module.exports = require("marko/src/html").t(__filename),
    ...
    marko_componentType = "/ipse$0.0.0/template/match/index.marko",
...
function render(input, out, __component, component, state) {
  ...
  if (data.inspiration) {
    out.w("<form entype=\"text/plain\" method=\"POST\" action=\"/match\" align=\"center\"><label>select a card</label><br><input type=\"text\" name=\"card\" placeholder=\"n\" maxlength=\"1\" size=\"1\"><input type=\"hidden\" name=\"id\"" +
...
marko_template.meta = {
    id: "/ipse$0.0.0/template/match/index.marko",
    component: "./",
    tags: [
